...
The adapter reports a firmware string like ``"v24.10 hw1 dreamcast"``. Split it
into a software version, a hardware revision, and a console/platform name.
"""
...
def parse_firmware(fw: str | None) -> tuple[str | None, str | None, str | None]:
    ...
    platform_tokens = [t for t in tokens[1:] if not t.lower().startswith("hw")]
